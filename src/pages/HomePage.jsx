...
function HomePage() {
  return (
    <div className="space-y-12 md:space-y-16">
      {/* 1. 히어로 섹션 */}
      {/* 화면이 작을 때는 패딩을 p-6으로, 태블릿 이상에서는 p-12로 조절 */}
      <section className="text-center bg-blue-50 p-6 md:p-12 rounded-lg">
        {/* 화면이 작을 때는 글자 크기를 3xl로, 태블릿 이상에서는 4xl로 조절 */}
      ...
      <section>
        ...
        {/* md:grid-cols-3: 태블릿 이상에서만 3열, 모바일에서는 자동으로 1열로 쌓임 */}
      ...
      <section>
        ...
        {/* 화면이 작을 때는 패딩을 p-6으로, 태블릿 이상에서는 p-8로 조절 */}
